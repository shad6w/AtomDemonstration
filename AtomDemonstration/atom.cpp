...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "VIVEKANANDA INSTITUTE OF TECHNOLOGY-BENGALURU";
        drawhead(-620, 900, 0, cn);
        char pn[] = "KUMBALGUDU,BENGALURU-560074";
        ...
        char g1[] = "Prof.DEEPTHI T K";
        drawhead(290, -250, 0, g1);
        char d1[] = "Professor, Dept. Of CSE, VKIT";
